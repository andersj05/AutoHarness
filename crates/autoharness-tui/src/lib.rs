...
pub use model::{
    ...
    MemoryFindingKind, MemoryLifecycleMode, MemoryLoadState, MemoryOrigin, MemoryPageDirection,
    MemoryPane, MemoryProjection, MemoryRelation, MemoryRelationKind, MemoryRevisionContext,
    MemoryScope, MemoryScopeFilter, MemorySensitivity, MemoryStatus, MemoryStatusFilter,
