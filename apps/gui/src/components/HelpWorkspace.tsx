...
const topics = [
  ...
  { title: "Appearance and accessibility", text: "Settings exposes theme, contrast, interface zoom up to 200 percent, conversation font size, density, reduced motion, timestamps, and submission behavior. Each preference explains its effective source and can reset a saved override. Tab and Shift + Tab move focus; Escape dismisses ordinary dialogs. Arrow keys resize focused pane separators, with Shift for larger steps." },
